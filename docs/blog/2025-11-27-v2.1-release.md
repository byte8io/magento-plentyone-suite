...
- 💬 Slack: [Join our community](https://softcommerce.slack.com)
- 🐛 Issues: [GitHub Issues](https://github.com/softcommerceltd/mage2plenty-os/issues)
- 📖 Docs: [Documentation Portal](https://docs.softcommerce.io)
...
**Ready to automate your integration?** [Upgrade to v2.1](https://github.com/softcommerceltd/mage2plenty-os/releases/tag/v2.1.0) today and experience the power of intelligent automation!