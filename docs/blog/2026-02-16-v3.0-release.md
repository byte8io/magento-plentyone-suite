...
```bash
# Update via Composer
composer require byte8/magento-plentyone-suite:^3.0
...
**Ready to supercharge your product exports?** [Upgrade to v3.0](https://github.com/byte8/mage2plenty/releases/tag/v3.0.0) today!
